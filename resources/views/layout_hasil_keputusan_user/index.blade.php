...
<div class="row">
    <div class="col-md-12">
        <a href="{{ route('hasil_keputusan_user.export.excel') }}" class="btn btn-success">Download Excel</a>
        <a href="{{ route('hasil_keputusan_user.export.pdf') }}" class="btn btn-danger">Download PDF</a>
    </div>
</div>
...
<script>
   $(document).ready(function() {
        $('#keputusanTable').DataTable({
            processing: true,
            serverSide: true,
            ajax: "{{ route('hasil_keputusan_user') }}", // Sesuaikan route dengan yang ada di routes/web.php
            columns: [
